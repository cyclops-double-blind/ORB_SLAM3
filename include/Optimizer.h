...
public:
    ...
    // Inertial pose-graph
    void static InertialOptimization(Map *pMap, Eigen::Matrix3d &Rwg, double &scale, Eigen::Vector3d &bg, Eigen::Vector3d &ba, bool bMono, Eigen::MatrixXd  &covInertial, std::ofstream& fDump, bool bFixedVel=false, bool bGauss=false, float priorG = 1e2, float priorA = 1e6);
